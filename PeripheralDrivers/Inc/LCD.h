...
uint8_t LCD_ReadByte (LCD_Handler_t *ptrHandlerLCD,uint8_t position, uint8_t memAddr);
...
void LCD_sendSTR(LCD_Handler_t *ptrHandlerLCD, char *str, uint8_t adress);
void LCD_Clear (LCD_Handler_t *ptrHandlerLCD, uint8_t adress);
void LCD_setCursor (LCD_Handler_t *ptrHandlerLCD, uint8_t x, uint8_t y, uint8_t adress);
void delay_50 (void);
void delay_5 (void);
void delay_1 (void);
void delay_10 (void);
